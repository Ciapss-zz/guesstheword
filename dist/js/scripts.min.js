...
var results=function($http){var get=function(){return $http.get("https://guesstheword-ed9bc.firebaseio.com/Results.json").then(function(response){return response.data;});};var save=function(results){return $http.post("https://guesstheword-ed9bc.firebaseio.com/Results.json",results);}
...
var ResultController=['$scope','$http','$location','getPassObj','results',function($scope,$http,$location,getPassObj,results){$scope.result=getPassObj.getObj();var getResults=function(){results.get().then(function(response){$scope.allResults=response;});};results.save($scope.result).then(function(response){getResults();});}];angular.module('myApp.result').controller('ResultController',ResultController);